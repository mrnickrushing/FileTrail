    ...
    <div className={styles.page}>
      ...
      <div className={styles.contentWrap}>
        ...
        <article className={styles.article}>
          <p className={styles.lead}>FileTrail stores your documents <strong>on your device</strong>. We do not collect, read, or sell your documents. If you don't enable cloud sync, your data never leaves your phone. Full stop.</p>
          ...
          <div className={styles.section} id="s2">
            ...
            <ul><li>Document files (images, PDFs)</li><li>Document metadata (title, category, tags, dates)</li><li>OCR-extracted text</li><li>Folders and organisational structure</li><li>App settings and preferences</li></ul>
          </div>
          ...
          <div className={styles.section} id="s4">
            ...
            <ul><li><strong>Account credentials</strong> — email address and a hashed password. We never store passwords in plain text.</li><li><strong>Encrypted document data</strong> — your documents are encrypted on your device before upload. We cannot read the contents of your documents.</li><li><strong>Sync metadata</strong> — timestamps and sync version numbers required to keep your devices in sync.</li><li><strong>Billing information</strong> — handled entirely by our payment processor (Stripe). We never see or store your full card details.</li></ul>
          </div>
          ...
          <div className={styles.section} id="s8">
            ...
            <ul><li><strong>Stripe</strong> — payment processing for Pro subscriptions. Subject to <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer">Stripe's Privacy Policy</a>.</li><li><strong>Apple / Google</strong> — app distribution and in-app purchases. Subject to their respective privacy policies.</li><li><strong>Railway</strong> — cloud infrastructure for the sync backend. Data is stored within Railway's infrastructure.</li></ul>
          ...
          <div className={styles.section} id="s10">
            ...
            <ul><li>The right to access the data we hold about you</li><li>The right to delete your account and all associated data</li><li>The right to export your data in a portable format</li><li>The right to opt out of analytics</li></ul>
          ...
          <div className={styles.section} id="s12">
            ...
            <p>We take security seriously. Local documents are protected by your device's security (including biometric lock). Cloud sync data is encrypted end-to-end before leaving your device. Our backend infrastructure is protected with industry-standard security practices.</p>
          </div>
